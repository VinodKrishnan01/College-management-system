...
const AddPlacement = () => {
  ...
  const addPlacementProfile = (e) => {
    e.preventDefault();
    toast.loading("Adding Placement");
    const headers = {
    ...
    axios
      .post(`${baseApiURL()}/placement/details/addDetails`, formData, {
        headers: headers,
      })
      .then((response) => {
        toast.dismiss();
        if (response.data.success) {
          ...
          axios
            .post(`${baseApiURL()}/placement/auth/register`, {
