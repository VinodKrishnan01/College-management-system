...
const EditPlacement = () => {
  ...
  const updatePlacementProfile = (e) => {
    e.preventDefault();
    toast.loading("Updating Placement");
    const headers = {
  ...
  const searchPlacementHandler = (e) => {
    setSearchActive(true);
    e.preventDefault();
    toast.loading("Getting Placement");
    const headers = {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (response.data.user.length === 0) {
          toast.error("No Placement Found!");
        } else {
          toast.success(response.data.message);
  ...
  return (
    <div className="my-6 mx-auto w-full">
      <form
        ...
        onSubmit={searchPlacementHandler}
      >
        <input
          type="text"
      ...
      {search && id && (
        <form
          onSubmit={updatePlacementProfile}
